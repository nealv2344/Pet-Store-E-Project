    ...
    <div class="container">
        ...
        <div class="row" id="order-table-div">
          <table id="order-table">
            ...
            <c:forEach items="${oH}" var="orderList">
            <c:forEach items="${o1}" var="orderInfo">      
            <tr>                                    
                <td>${orderList.getOrderNo()}</td>
                <td>${orderList.getCustID()}</td>                    
                
                
                <td>${orderInfo.getSku()}</td>
                <td>${orderInfo.getQuantity()}</td>
            </tr>
            </c:forEach>
            </c:forEach>
        ...
        <div class="row" id="deleteCustomer">
            ...
            <input type="text" name="customerId"id="deleteCustomer" placeholder="customer id num">
            <input type="submit" name="submit" id="submit" value="Delete">
          </form>
        </div>
        ...
        <div class="row" id="customerHistory">
            ...
            <input type="text" name="customerId"id="customerHistory" placeholder="customer id num">
